...
function f8() {
    ...
    document.querySelector('.out-8').append(newDiv);
}
...
let i11 = document.querySelector('.i-111');
...
let i121 = document.querySelector('.i-12');

function f12() {
    document.querySelector('.out-12').innerHTML = i121.value;
}
...
function f14() {
    document.querySelector('.out-14').innerHTML = textArea.value;
}
...
function f18() {
    let val = document.querySelector('.i-18');
    val.value = s18.value;
...
let s20 = document.querySelector('.s-201');
let s21 = document.querySelector('.s-202');
