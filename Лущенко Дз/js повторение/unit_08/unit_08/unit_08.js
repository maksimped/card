...
let k = 1;
while(k <= 50){
    document.querySelector('.out-1').innerHTML += k++ + '_';
...
while(y < 1966){
     ...
     if( y % 2 === 0){
         document.querySelector('.out-10').innerHTML += y + "_";
     }
}
...
let i = '';
while(n < div.length){
    i += div[n].textContent + '_'
    n++
    document.querySelector('.out-11').innerHTML = i;
}
...
function t14() {
    ...
    document.querySelector('.out-14').innerHTML = i;
}
