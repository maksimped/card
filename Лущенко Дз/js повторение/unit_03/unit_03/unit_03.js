...
function f1() {
   let v1 = document.querySelector('.i-1').value;
   if (v1 == 4) {
...
function f3() {
   let i3 = +document.querySelector('.i-31').value;
...
function f7() {
   let val = document.querySelector('.i-71').value;
   let exp = document.querySelector('.i-72').value;
   document.querySelector('.out-7').innerHTML = val ** exp;
}
...
function f8() {
   ...
   switch (select) {
      ...
      case 2:
         ...
         break;
      case 3:
         document.querySelector('.out-8').innerHTML = 'tree'
         break;
   }
...
function f14() {
   ...
   let res = num1 + sel1 + num2;

   document.querySelector('.out-14').innerHTML = eval(res);
}
...
function f15() {
   ...
   let sel1 = document.querySelector('.s-153').value;
   let res = num1 + sel1 + num2;
   document.querySelector('.out-15').innerHTML = eval(res);
}
