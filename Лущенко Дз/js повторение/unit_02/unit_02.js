...
function t12() {
    ...
    document.querySelector('.out-12').innerHTML = `${name} ${surname}`;
}
...
function t13() {
    ...
    document.querySelector('.out-13').innerHTML = num1 + num2;
}
...
function t18() {
    let num1 = document.querySelector('.i-18').value;
    // let p = parseFloat(num1)
    document.querySelector('.out-18').innerHTML = parseFloat(num1);
}
