...
const auth = '?auth=DdC33D7d2C2a7',
    ...
    num1 = '&num1=',
    num2 = '&num2=',
    link = 'http://getpost.openssource.biz/sekret-bystryx-deneg-kak-zarabatyvat-700-1400-rublej-v-den.html/',
    year = '&year=',
    m = '&m=',
    d = '&d=',
    y = '&y=';
...
function t2() {
    fetch(`${link}${auth}${action}2${name1}maks`)
        .then(data => {
...
function t3() {
    fetch(`${link}${auth}${action}3${num1}3${num2}4`)
        .then(data => {
...
function t4() {
    fetch(`${link}${auth}${action}4${num1}1${num2}4`)
        .then(data => {
...
function t6() {
    fetch(`${link}${auth}${action}6${num1}9${num2}4`)
        .then(data => {
...
function t8() {
    fetch(`${link}${auth}${action}8${year}1990`)
        .then(data => {
...
function t9() {
    fetch(`${link}${auth}${action}9${m}1${d}1${y}1`)
        .then(data => {
...
function t12() {
    fetch(`${link}${auth}${action}3${num1}4${num2}6`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
...
function t13() {
    fetch(`${link}${auth}${action}4${num1}4${num2}6`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
...
function t15() {
    fetch(`${link}${auth}${action}6${num1}4${num2}6`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
