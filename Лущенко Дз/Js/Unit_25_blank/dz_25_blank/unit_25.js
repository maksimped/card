...
function t1() {
    ...
    request.open('GET', `${link}${auth}${action}1`)
    request.send()
...
function t2() {
    ...
    request.open('GET', `${link}${auth}${action}2${name1}maks`)
    request.send()
...
function t3() {
    ...
    request.open('GET', `${link}${auth}${action}3${num1}3${num2}4`)
    request.send();

    function myFunction(data) {
        document.querySelector('.out-3').innerText = data;
        a = data;
    }
}
...
function t4() {
    ...
    request.open('GET', `${link}${auth}${action}4${num1}1${num2}4`)
    request.send();
...
function t5() {
    ...
    request.open('GET', `${link}${auth}${action}5`)
    request.send();
...
function t6() {
    ...
    request.open('GET', `${link}${auth}${action}6${num1}9${num2}4`)
    request.send();
...
function t7() {
    ...
    request.open('GET', `${link}${auth}${action}7`)
    request.send();
...
function t8() {
    ...
    request.open('GET', `${link}${auth}${action}8${year}1990`)
    request.send()
...
function t9() {
    ...
    request.open('GET', `${link}${auth}${action}9 ${m}1 ${d}1 ${y}1`)
    request.send()

    function myFunction(data) {
        document.querySelector('.out-9').innerText = data;
        a = data;
    }
}
...
function t11() {
    ...
    requestPost.open('POST', `${link}${auth}${action}2${name1}Maksim`);
    requestPost.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    requestPost.send(`${auth}${action}2`)
...
function t12() {
    ...
    requestPost.open('POST', `${link}${auth}${action}3${num1}4${num2}9`);
    requestPost.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    requestPost.send(`${auth}`)
...
function t13() {
    ...
    requestPost.open('POST', `${link}${auth}${action}4${num1}4${num2}9`);
    requestPost.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    requestPost.send(`${auth}`)
...
function t14() {
    ...
    requestPost.open('POST', `${link}${auth}${action}5`);
    requestPost.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    requestPost.send(`${auth}`)
...
function t15() {
    ...
    requestPost.open('POST', `${link}${auth}${action}6${num1}5${num2}10`);
    requestPost.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    requestPost.send(`${auth}`)
...
function t16() {
    ...
    requestPost.open('POST', `${link}${auth}${action}7$`);
    requestPost.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    requestPost.send(`${auth}`)
    ...
    function myFunction2(data) {
        ...
        document.querySelector('.out-16').appendChild(img2)
...
function t17() {
    ...
    requestPost.open('POST', `${link}${auth}${action}8${year}1990`);
    requestPost.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    requestPost.send(`${auth}`)
...
function t18() {
    ...
    requestPost.open('POST', `${link}${auth}${action}9${m}1${y}1${d}1`);
    requestPost.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    requestPost.send(`${auth}`)
