...
function f81() {
    ...
    let inputValue = document.querySelector('.out-8 input').value;
    out2.innerHTML = inputValue;
}
...
function f9() {
    ...
    if (inputRadio.checked) {
        out.innerHTML = inputRadio.value;
    } else {
        out.innerHTML = '0';
    }
}
...
function f10() {
    ...
    out.style.backgroundColor = inputColor;
...
function f11() {
    let inputColor1 = document.querySelector('.i-111');
    let inputColor2 = document.querySelector('.i-112');
...
function f12() {
    let inputDate = document.querySelector('.i-12');
    let out = document.querySelector('.out-12');
    out.innerHTML = inputDate.value;
}
...
function f13() {
    let inputRange = document.querySelector('.i-13');
...
function f14() {
    let txt = document.querySelector('.t-14');
...
function f19() {
    ...
    let inputPass = document.querySelector('.i-192').value;
    let out = document.querySelector('.out-19');

    out.innerHTML = `${inputText} ${inputPass}`;
...
function f20(e) {
    ...
    let inputText = form.elements["username"].value;
