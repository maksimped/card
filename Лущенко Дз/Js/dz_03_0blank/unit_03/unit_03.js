...
function f4() {
    let ear = document.querySelector('.i-4').value;
...
function f7() {
    ...
    let putIn = document.querySelector('.i-72').value;
    let out = document.querySelector('.out-7');
    let result = Math.pow(num, putIn);
...
function f14() {
    ...
    let action = document.querySelector('.s-143').value;
...
function f15() {
    ...
    let action = document.querySelector('.s-153').value;
